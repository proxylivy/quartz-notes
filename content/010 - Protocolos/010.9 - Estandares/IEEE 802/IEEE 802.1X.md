...
Componentes:
- EAP (Protocolo de Autenticacion Extensible): Definido por varios RFC[^1] e IEEE[^2], proporcionando un transporte encapsulado para autenticar, 
...
[^2]: [IEEE 802.1X-2020](https://standards.ieee.org/ieee/802.1X/7345/)
...
# Extras
La entrada de [Wikipedia EN - IEEE 802.1X](https://en.wikipedia.org/wiki/IEEE_802.1X) recopila informacion