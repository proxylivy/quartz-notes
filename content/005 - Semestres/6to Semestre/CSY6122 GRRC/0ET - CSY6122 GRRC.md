...
- Descargar [Nessus](https://www.tenable.com/downloads/nessus) (10.11.0) para "Linux - Ubuntu - AMD64" o con el link en curl desde el VM
```
curl --request GET --url 'https://www.tenable.com/downloads/api/v2/pages/nessus/files/Nessus-10.11.0-ubuntu1604_amd64.deb' --output 'Nessus-10.11.0-ubuntu1604_amd64.deb'
```
