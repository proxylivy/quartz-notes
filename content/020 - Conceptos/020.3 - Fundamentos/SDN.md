# Info
**S**oftware **D**efined **N**etwork o Redes Definidas por Software, Permiten aplicar modularidad a la red, separando el "Plano de Control" y "Plano de Datos" del Hardware, tambien puede unificar diferentes "Planos de Control" en uno solo y manejar varios "Planos de datos" via API, otra aproximacion a SDN, es, Permitir administrar recursos fisicos en multiples logicos.
...
- [Mininet Lab](http://mininet.org/): Plataforma de simulacion de redes SDN con enfoque IaC (Infraestructure as code)
...
- [YAML](https://yaml.org/) (YAML Ain't Markup Language): Serializacion de datos amigable con el humano para todos los lenguajes de programacion 

# Extras
## Papel de Openflow
OpenFlow empezo la fiebre del SDN pero su modelo de funcionamiento era ineficiente debido a que el vendedor tenia que implementarlo en su sistema, pero marco un primer paso. El objetivo final es crear una arquitectura de software que te permita contruir redes sin preocuparte por el hardware.
